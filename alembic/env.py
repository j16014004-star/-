...
import app.models.user  # noqa: F401 — ensure all models are imported
import app.models.resume  # noqa: F401 — ensure all models are imported
...
def run_migrations_online() -> None:
    """Run migrations in 'online' mode, using sync driver for pymysql."""
